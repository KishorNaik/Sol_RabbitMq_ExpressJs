...
export class App {
	...
	public initializeDatabase(init: Function) {
		console.log('testDB Function init');
		this._initializeDatabase = init;
		return this;
	}

	public initializeAndRunPubSubRabbitMqConsumer(init: Function[], run: Function) {
		this._initializePubSubRabbitMqConsumers = init;
		this._runPubSubRabbitMqConsumers = run.bind(consumerRegistry);
		return this;
	}

	public initializeAndRunRequestReplyRabbitMqConsumer(init: Function[], run: Function) {
	...
	public listen() {
		this.app.listen(this.port, async () => {
			...
			if (this._initializePubSubRabbitMqConsumers && this._runPubSubRabbitMqConsumers) {
				logger.info(
